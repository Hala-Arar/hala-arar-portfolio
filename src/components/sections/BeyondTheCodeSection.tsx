        ...
        <div className="relative">
          ...
          >
            {interests.map((interest, index) => (
              ...
              >
                <div className="group relative bg-surface-light border border-gray-200 rounded-2xl overflow-hidden transition-all duration-300 hover:border-indigo hover:shadow-xl hover:-translate-y-2 hover:glow-indigo">
                  {/* Photo Placeholder */}
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="text-lg font-bold text-[hsl(var(--text-light-primary))] group-hover:text-indigo transition-colors">
                        {interest.label}
                      </h3>
                    </div>
                  </div>
