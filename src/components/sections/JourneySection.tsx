...
const timeline: TimelineEntry[] = [
  ...
  },
  {
    ...
    description: "Developed XGBoost and LLM models for clinical gene variant classification using ACMG guidelines",
  ...
  },
  {
    ...
    description: "Led environmental education programs, managed teams, organized community events",
    logo: "/logos/OFAH.png",
    isImage: true,
    logoScale: 1.1,
  },
  {
    ...
    location: "Peterborough, ON",
    period: "2018-2020",
    description: "Trained new employees, optimized workflows, maintained quality standards",
...
const education = [
  {
    ...
    period: "2024 – 2025",
    details: ["Advanced ML", "Causal Inference", "NLP", "Cloud Systems"],
  ...
  },
  {
    ...
    period: "2020 – 2024",
    details: ["Dean's Honour Roll", "Renewable Entrance Scholarship"],
