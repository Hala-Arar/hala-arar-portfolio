      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center space-y-12">
          ...
          >
            ...
            >
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gray-100 border-2 border-gray-300 flex items-center justify-center group-hover:border-indigo group-hover:glow-indigo transition-all">
                <Mail className="text-gray-700 group-hover:text-indigo transition-smooth" size={28} />
              </div>
              <span className="text-sm text-gray-600 group-hover:text-indigo transition-colors">
                Email
              </span>
            </a>
            ...
            >
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gray-100 border-2 border-gray-300 flex items-center justify-center group-hover:border-indigo group-hover:glow-indigo transition-all">
                <Github className="text-gray-700 group-hover:text-indigo transition-smooth" size={28} />
              </div>
              <span className="text-sm text-gray-600 group-hover:text-indigo transition-colors">
                GitHub
              </span>
            ...
            >
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gray-100 border-2 border-gray-300 flex items-center justify-center group-hover:border-indigo group-hover:glow-indigo transition-all">
                <Linkedin className="text-gray-700 group-hover:text-indigo transition-smooth" size={28} />
              </div>
              <span className="text-sm text-gray-600 group-hover:text-indigo transition-colors">
                LinkedIn
              </span>
